...
│❒ ${petik}Author : Abw${petik}
│❒ ${petik}hobi : di sakiti${petik}
...
│❒ ${petik}${prefix}bugtroli${petik}
│❒ ${petik}${prefix}bugtroli2${petik}
│❒ ${petik}${prefix}bugcombine${petik}
│❒ ${petik}${prefix}bugpc${petik}
│❒ ${petik}${prefix}bugpc2${petik}
│❒ ${petik}${prefix}buggc${petik}
│❒ ${petik}${prefix}sendbug${petik}
│❒ ${petik}${prefix}bughole${petik}
│
├◪ ⧉ *MAKER MENU* ⧉
│
